...
const AddProduct = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 bg-white rounded-md">
      {/* Product Image */}
      <div className="mb-6">
      ...
      <div className="flex justify-end">
        <button
          className="bg-[var(--btn-color)] cursor-pointer text-white font-semibold px-6 py-2 rounded hover:bg-amber-900 transition"
