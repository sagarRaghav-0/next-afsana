    ...
    return (
        <>
            <div className="flex px-5 md:px-10 my-5 items-center justify-between">
                {/* Logo / Brand */}
                <Link href="/" className="font-crl text-4xl  tracking-wide">
                    Afsana
                </Link>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <SignedOut>
                        ...
                        >
                            <button className="py-2 px-4 cursor-pointer bg-[var(--btn-color)] text-white font-bold hover:bg-amber-900 rounded-full">
                                Sign In
                            </button>
                        </SignInButton>
                    </SignedOut>
